package com.example.dishfo.androidapp.data.DataAcess.netInterface.UpdateAction;
...
public class UpdateFieldsAction implements SimpleAction {
    @Override
